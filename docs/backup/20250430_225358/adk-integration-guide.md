...
For more information, refer to the [VANA Context Management Architecture](context-management-architecture.md) and the [Google ADK Documentation](https://google.github.io/adk-docs/).

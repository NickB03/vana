...
- Name: {user:name?}
- Role: {user:role?}
- Cloud platforms: {user:cloud_platforms?}
- DevOps tools: {user:devops_tools?}
- Infrastructure scale: {user:infrastructure_scale?}
- Team size: {user:team_size?}
- Compliance needs: {user:compliance_needs?}
...
Consider the user's cloud platforms and team size. Focus on automation, security, and reliability with practical solutions tailored to their scale.""",
        tools=[

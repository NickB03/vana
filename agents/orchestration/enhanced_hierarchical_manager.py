...
from lib._tools.registry import get_tool_registry, ToolCategory
...
class EnhancedHierarchicalTaskManager:
    ...
    def analyze_and_route_task(self, task_description: str, 
        ...
        workflow_handler = self.workflow_strategies.get(
            analysis.recommended_approach,
            self._adaptive_workflow
        )
        
        return workflow_handler(analysis, task_description)
        
    def _handle_security_critical_task(self, analysis: TaskAnalysisResult, 
    ...
    def _security_first_workflow(self, analysis: TaskAnalysisResult, 
                               task_description: str) -> Dict[str, Any]:
    ...
    def _single_specialist_workflow(self, analysis: TaskAnalysisResult,
                                  task_description: str) -> Dict[str, Any]:
    ...
    def _parallel_analysis_workflow(self, analysis: TaskAnalysisResult,
                                  task_description: str) -> Dict[str, Any]:
    ...
    def _sequential_workflow(self, analysis: TaskAnalysisResult,
                           task_description: str) -> Dict[str, Any]:
        """Sequential workflow execution"""
        phases = []
        
        # Order specialists based on task flow
        ordered_specialists = self._order_specialists_for_sequential(
            analysis.required_specialists,
            analysis.task_type
        )
    ...
    def _phased_project_workflow(self, analysis: TaskAnalysisResult,
                               task_description: str) -> Dict[str, Any]:
    ...
    def _hierarchical_decomposition(self, analysis: TaskAnalysisResult,
                                  task_description: str) -> Dict[str, Any]:
    ...
    def _adaptive_workflow(self, analysis: TaskAnalysisResult,
                         task_description: str) -> Dict[str, Any]:
    ...
    def _order_specialists_for_sequential(self, specialists: List[str], 
    ...
    def _decompose_enterprise_task(self, task_description: str, 
                                  analysis: TaskAnalysisResult) -> List[Dict[str, Any]]:

    ...
    package_info = {
        "python": {
            "standard_library": [
                ...
                "urllib", "http", "email", "csv", "sqlite3", "logging", "unittest"
            ],
            "data_science": [
                "numpy", "pandas", "matplotlib", "seaborn", "scipy", "scikit-learn"
            ],
            "web_development": [
                "requests", "flask", "fastapi", "aiohttp"
            ],
            "utilities": [
                "pyyaml", "python-dotenv", "click", "tqdm", "pillow"
            ],
            "restricted": [
        ...
        "javascript": {
            "core_modules": [
                ...
                "crypto", "url", "querystring", "assert"
            ],
            "utilities": [
                "lodash", "moment", "axios", "uuid", "chalk", "commander"
            ],
            "development": [
                "jest", "mocha", "chai", "sinon", "eslint", "prettier"
            ],
            "restricted": [
        ...
        "shell": {
            ...
            "text_processing": [
                "cut", "tr", "wc", "diff", "comm", "join", "paste"
            ],
            "file_operations": [
                "find", "locate", "which", "file", "stat", "touch", "chmod"
            ],
            "restricted": [
                "sudo", "su", "passwd", "mount", "umount", "systemctl",
                "service", "crontab", "at", "nohup", "screen", "tmux"
            ]
        }
    }

...
logical_analyze for reasoning tasks, and file tools for basic file operations.
Delegate code tasks to code_execution agent and data tasks to data_science agent.""",
    tools=[

...
from lib._shared_libraries.orchestrator_metrics import (
...
def route_to_specialist(request: str, task_type: str, context: Dict[str, any] = None) -> str:
    ...
    security_keywords = ["security", "vulnerability", "exploit", "injection", "xss", "csrf", 
                        "authentication", "authorization", "encryption", "certificate", "ssl", 
                        "tls", "password", "secret", "token", "breach", "attack"]

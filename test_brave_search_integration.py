...
def test_brave_search_client():
    ...
    try:
        ...
        if client.is_available():
            ...
            print("   ❌ Brave Search client not available (missing API key)")
        ...
        if mock_client.is_available():
            print("   ✅ Mock Brave Search client is available")
            ...
            if mock_results:
                print(
                    f"   📄 First mock result: {mock_results[0].get('title', 'No title')}"
                )
...
def test_web_search_client():
    ...
    try:
        ...
        if hasattr(client, "available") and client.available:
            print("   ✅ WebSearchClient is available")
            ...
            print("   ❌ WebSearchClient not available")
...
def test_adk_web_search_tool():
    ...
    try:
        ...
        print("   ✅ ADK web search completed")

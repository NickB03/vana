    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper flex min-h-svh w-full has-data-[variant=inset]/sidebar:bg-sidebar",
            className
          )}
          ref={ref}
          {...props}
...
>(({ className, style, ...props }, ref) => {
  ...
  return (
    <main
      ref={ref}
      style={{ paddingLeft, transition: "padding-left 200ms linear", ...(style as React.CSSProperties) }}
      className={cn(
        "relative flex h-svh flex-1 min-w-0 flex-col bg-background",

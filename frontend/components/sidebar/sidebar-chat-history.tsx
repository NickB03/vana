    ...
    <Sidebar collapsible="icon">
      <SidebarHeader className="flex flex-row items-center justify-between gap-2 px-2 py-4">
        <div className="flex flex-row items-center gap-2 px-2">
          ...
          <div className="text-md font-base text-primary tracking-tight group-data-[collapsible=icon]:hidden">
            vana.chat
          </div>
        </div>
        <Button variant="ghost" className="size-8 group-data-[collapsible=icon]:hidden">
...
function SidebarChatHistory({ children }: { children?: React.ReactNode }) {
  return (
    <SidebarProvider>
...
export { SidebarChatHistory, SidebarWithChatHistory }
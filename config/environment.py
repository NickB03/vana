...
class EnvironmentConfig:
    ...
    def get_adk_memory_config():
        ...
        rag_corpus_resource_name = (
            ...
            or "projects/analystai-454200/locations/us-central1/ragCorpora/vana-corpus"
        )
    ...
    def validate_adk_memory_config():
        ...
        try:
            ...
            if found_deprecated:
                validation_results["warnings"].append(
                    f"Deprecated MCP variables found: {found_deprecated}. These should be removed."
                )
    ...
    def get_migration_status():
        ...
        if any(os.environ.get(var) for var in mcp_vars):
            ...
            status["recommendations"].append(
                "Remove deprecated MCP variables from environment"
            )

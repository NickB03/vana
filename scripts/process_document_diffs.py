...
class DiffProcessor:
    ...
    def parse_diff_file(self, diff_file: str) -> Dict[str, Any]:
        ...
        if not os.path.exists(diff_file):
            ...
            return {"success": False, "reason": "Diff file not found", "file_path": diff_file}
    ...
    def update_knowledge_base(self, chunks: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        if self.vs_available and added_chunks:
            for chunk in added_chunks:
                try:
                    result = self.vs_client.add_document(text=chunk["text"], metadata=chunk["metadata"])
    ...
    def process_directory(self, directory: str) -> Dict[str, Any]:
        ...
        if not os.path.exists(directory):
            ...
            return {"success": False, "reason": "Directory not found", "directory": directory}
...
def main():
    ...
    diff_processor = DiffProcessor(chunk_size=args.chunk_size, chunk_overlap=args.chunk_overlap)

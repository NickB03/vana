...
class JunoRemoteTester(JunoAutonomousTester):
    ...
    async def _test_all_16_tools(self) -> dict[str, Any]:
        ...
        tool_tests = [
            {
                "tool": "echo",
                "input": "echo tool test",
                "expected_keywords": ["tool test"],
            },
            {
            ...
            },
            {
                "tool": "vector_search",
                "input": "search for AI",
                "expected_keywords": ["search", "results"],
            },
            {
                "tool": "web_search",
                "input": "web search python",
                "expected_keywords": ["python", "search"],
            },
            {
                "tool": "knowledge_graph",
                "input": "what is VANA",
                "expected_keywords": ["VANA", "agent"],
            },

...
class VSCodeMemoryIntegration:
    ...
    async def _index_workspace_files(self, workspace: Path):
        ...
        watch_patterns = self.workspace_config.get("vana.memory.watchPatterns", [
            "**/*.md", "**/*.py", "**/*.js", "**/*.ts"
        ])
        
        exclude_patterns = self.workspace_config.get("vana.memory.excludePatterns", [
            "**/node_modules/**", "**/.git/**"
        ])
    ...
    def generate_vscode_extension_manifest(self) -> Dict[str, Any]:
        ...
        manifest = {
            ...
            "contributes": {
                "commands": [
                    {
                        "command": "vana.memory.indexCurrentFile",
                        "title": "Index Current File in Memory"
                    },
                    {
                        "command": "vana.memory.searchMemory", 
                        "title": "Search Memory"
                    },
                    {
                        "command": "vana.memory.getFileContext",
                        "title": "Get Context for Current File"
                    },
                    {
                        "command": "vana.memory.suggestRelatedFiles",
                        "title": "Suggest Related Files"
                    }
                ],
                "keybindings": [
                    {

...
def check_current_status():
    ...
    print(f"Image Processing:            {'✅ Enabled' if (pil_available and pytesseract_available and tesseract_available) else '⚠️  Graceful fallback'}")
...
Examples:
  ...
  python scripts/install_optional_dependencies.py --images  # Images only
    ...
    parser.add_argument('--pdf', action='store_true',
                       help='Install PDF processing dependencies')
    parser.add_argument('--images', action='store_true', 
                       help='Install image processing dependencies')

...
def main():
    ...
    parser.add_argument("--include-web", action="store_true", default=True, help="Include web search results")
    parser.add_argument("--use-mock", action="store_true", help="Use mock implementations for testing")
    ...
    results = hybrid_search.search(args.query, top_k=args.top_k, include_web=args.include_web)

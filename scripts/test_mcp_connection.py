...
def test_knowledge_graph_connection(
    server_url: str, api_key: str, namespace: str
) -> bool:
    ...
    try:
        ...
        if response.status_code == 200 or response.status_code == 201:
            ...
            delete_response = requests.delete(
                delete_url, headers=headers, json={"entityNames": ["TestEntity"]}
            )
            ...
            if delete_response.status_code == 200:
                ...
                print(
                    f"⚠️ Failed to delete test entity. Status code: {delete_response.status_code}"
                )
            ...
            print(
                f"❌ Failed to connect to MCP Knowledge Graph server. Status code: {response.status_code}"
            )

...
class VanaSetupValidator:
    ...
    def test_security_imports(self) -> bool:
        ...
        try:
            from tools.security import Role, AccessControlManager, Operation, PermissionLevel
            from tools.security import CredentialManager, AuditLogger
...
def main():
    ...
    parser.add_argument("--comprehensive", action="store_true",
                       help="Run comprehensive validation including all optional dependencies")

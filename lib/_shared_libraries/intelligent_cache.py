...
class ToolResultCache(IntelligentCache):
    ...
    def _initialize_tool_patterns(self) -> dict[str, dict[str, Any]]:
        ...
        return {
            ...
            "file_tools": {
                "ttl": 3600,  # 1 hour for file operations
                "similarity_threshold": 0.9,
            },
            "kg_tools": {
                "ttl": 7200,  # 2 hours for knowledge graph
                "similarity_threshold": 0.85,
            },
            "system_tools": {
                "ttl": 300,  # 5 minutes for system status
...
def clear_all_caches():
    ...
    agent_decision_cache.hits = (
        agent_decision_cache.misses
    ) = agent_decision_cache.evictions = 0

...
class ModeManager:
    ...
    def analyze_task_complexity(self, task_description: str) -> float:
        ...
        complexity_indicators = {
            # File operations
            "read": 0.1, "write": 0.2, "create": 0.3, "delete": 0.4,
            # Search operations
            "search": 0.3, "find": 0.3, "query": 0.4,
            # Multi-step operations
            "analyze": 0.6, "implement": 0.7, "design": 0.8, "architect": 0.9,
            # Coordination operations
            "coordinate": 0.8, "orchestrate": 0.9, "manage": 0.7,
            # Complex keywords
            "multiple": 0.5, "complex": 0.7, "comprehensive": 0.8, "advanced": 0.9
        }
        ...
        if len(complexity_scores) >= 3:
            ...
            return (complexity_scores[0] * 0.5 +

...
def documentation_tool(context: str) -> str:
    ...
    try:
        ...
        task_manager.update_task(
            task_id, LongRunningTaskStatus.IN_PROGRESS,
            result=result, progress=0.1,
            metadata={"current_stage": "Analyzing documentation requirements", "documentation_type": "technical_writing"}
        )
...
def coordination_tool(context: str) -> str:
    ...
    try:
        ...
        task_manager.update_task(
            task_id, LongRunningTaskStatus.IN_PROGRESS,
            result=result, progress=0.2,
            metadata={"current_stage": "Analyzing coordination requirements", "coordination_type": "workflow_management"}
        )

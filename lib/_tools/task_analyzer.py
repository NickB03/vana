...
class TaskAnalyzer:
    ...
    def _initialize_capability_keywords(self) -> Dict[str, List[str]]:
        ...
        return {
            "code_execution": ["python", "javascript", "shell", "bash", "script", "execute", "run", "code"],
            "data_analysis": ["data", "analyze", "statistics", "chart", "visualization", "pandas", "numpy"],
            "knowledge_search": ["search", "find", "lookup", "research", "knowledge", "information"],
            "memory_management": ["memory", "store", "retrieve", "cache", "database", "index"],
            "workflow_automation": ["workflow", "automate", "process", "pipeline", "sequence"],
            "communication": ["send", "message", "notify", "communicate", "route", "forward"],
        }
    ...
    def _initialize_complexity_indicators(self) -> Dict[TaskComplexity, Dict[str, Any]]:
        ...
        return {
            ...
            TaskComplexity.COMPLEX: {
                "max_words": 100,
                "keywords": ["complex", "advanced", "detailed", "comprehensive", "integrate"],
                "patterns": [r"\b(many|various|different|multiple.*and)\b"],
            },
            TaskComplexity.VERY_COMPLEX: {
                "max_words": float("inf"),
                "keywords": ["orchestrate", "coordinate", "optimize", "machine learning", "ai"],
    ...
    def _generate_reasoning(
        self, task_type: TaskType, complexity: TaskComplexity, keywords: List[str], capabilities: List[str]
    ) -> str:

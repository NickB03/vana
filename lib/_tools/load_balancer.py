...
class LoadBalancer:
    ...
    async def register_task_start(self, agent_name: str, task_id: str, task_info: Dict[str, Any]):
        ...
        task_record = {"task_id": task_id, "start_time": time.time(), "task_info": task_info}
    ...
    async def queue_task(self, agent_name: str, task_id: str, task_info: Dict[str, Any], priority: str = "normal"):
        """Queue a task for an agent."""
        task_record = {"task_id": task_id, "queue_time": time.time(), "task_info": task_info, "priority": priority}
    ...
    def get_load_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "load_distribution": {
                "most_loaded_agent": {"name": most_loaded.agent_name, "utilization": most_loaded.utilization},
                "least_loaded_agent": {"name": least_loaded.agent_name, "utilization": least_loaded.utilization},
            },

...
class AgentInterface(ABC):
    ...
    async def execute_task(
        self, task: str, context: str = "", agent_id: str = "", priority: str = "normal", timeout_seconds: int = 30
    ) -> AgentTaskResponse:
    ...
    async def send_task_to_agent(
        ...
        if response.error:
            ...
            return {"status": "success", "result": response.result, "target_agent": target_agent}
    ...
    async def check_agent_health(self, target_agent: str) -> Dict[str, Any]:
        ...
        if response.error:
            return {"agent_name": target_agent, "status": "unhealthy", "error": response.error.message}
        else:
...
class OrchestrationAgentInterface(AgentInterface):
    ...
    async def get_capabilities(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "type": "orchestration",
            "methods": ["execute_task", "get_capabilities", "health_check", "delegate_task", "route_task"],

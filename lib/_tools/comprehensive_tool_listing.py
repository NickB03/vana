...
def list_all_agent_tools() -> str:
    ...
    try:
        ...
        travel_specialist_tools = [
            "hotel_search_tool", "flight_search_tool", "payment_processing_tool", "itinerary_planning_tool"
        ]
        
        # Specialist Agent Tools - Research
        research_specialist_tools = [
            "web_research_tool", "data_analysis_tool", "competitive_intelligence_tool"
        ]
        
        # Specialist Agent Tools - Development
        development_specialist_tools = [
            "code_generation_tool", "testing_tool", "documentation_tool", "security_tool"
        ]
        ...
        # Third-Party Tools
        third_party_tools = [
            "execute_third_party_tool", "list_third_party_tools",
            "register_langchain_tools", "register_crewai_tools",
        ...
        grand_total = (total_base + total_long_running + total_mcp_time + 
                      total_mcp_filesystem + total_mcp_core + total_travel + 
                      total_research + total_development + total_core + 
                      total_intelligence + total_utility + total_third_party)

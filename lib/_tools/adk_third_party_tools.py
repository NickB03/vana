...
def register_langchain_tools() -> str:
    ...
    try:
        ...
        mock_calculator = MockLangChainTool(
            calculator_langchain, "calculator_langchain", "Calculate mathematical expressions"
        )
...
def register_crewai_tools() -> str:
    ...
    try:
        ...
        mock_formatter = MockCrewAITool(
            format_string_crewai, "StringFormatterCrewAI", "Format strings using various formatting options"
        )
        mock_processor = MockCrewAITool(
            process_list_crewai, "ListProcessorCrewAI", "Process and manipulate comma-separated lists"
        )

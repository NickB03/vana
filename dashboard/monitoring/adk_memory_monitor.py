...
class ADKMemoryMonitor:
    ...
    def check_health(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": status,
                "message": "ADK Memory system operational"
                if status == "ok"
    ...
    def get_metrics_history(self, hours: int = 24) -> list[dict[str, Any]]:
        ...
        return [m for m in self.metrics_history if m["timestamp"] > cutoff_iso]
    ...
    def get_cost_history(self, hours: int = 24) -> list[dict[str, Any]]:
        ...
        return [c for c in self.cost_history if c["timestamp"] > cutoff_iso]

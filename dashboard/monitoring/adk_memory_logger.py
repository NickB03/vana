...
class ADKMemoryLogger:
    ...
    def start_operation_trace(
        self, operation_id: str, operation_type: str, context: dict[str, Any] = None
    ):
    ...
    def end_operation_trace(
        self, operation_id: str, success: bool = True, result: dict[str, Any] = None
    ):
    ...
    def get_operation_logs(
        self, hours: int = 24, operation_type: str = None
    ) -> list[dict[str, Any]]:
        ...
        try:
            ...
            if self.operations_log.exists():
                with open(self.operations_log) as f:
                    for line in f:
                        try:

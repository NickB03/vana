    ...
    def _calculate_trends(self) -> Dict[str, Any]:
        ...
        if current_rt != 0 and previous_rt != 0:
            ...
            trends["response_time"] = {
                ...
                "trend": "improving" if current_rt < previous_rt else "degrading" if current_rt > previous_rt else "stable"
            }
        ...
        if current_sr != 0 and previous_sr != 0:
            ...
            trends["success_rate"] = {
                ...
                "change": sr_change,
                "trend": "improving" if current_sr > previous_sr else "degrading" if current_sr < previous_sr else "stable"
            }

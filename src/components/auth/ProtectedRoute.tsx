...
import { useAuth, useRequireAuth, useRoleGuard, usePermissionGuard } from '@/hooks/useAuth';
...
function Unauthorized({ type, requiredRole, requiredPermission, redirectTo }: UnauthorizedProps) {

...
// Enhanced V2 game for premium demo experience
import { FroggerGameV2 } from '@/components/demo/FroggerGameV2';

/**
 * DemoModeV2 - Enhanced demo with FroggerGameV2
 *
 * Uses the premium FroggerGameV2 with:
 * - Smooth hop animations with parabolic arcs
 * - Particle effects (trail, sparks, confetti)
...
const FROGGER_ARTIFACT: ArtifactData = {
  id: 'demo-frogger-artifact-v2',
  type: 'react',
  title: 'Frogger Game',
  content: '// Enhanced V2 component with animations and effects',
  language: 'tsx',
};
...
// Custom artifact renderer that uses enhanced FroggerGameV2
...
export default function DemoModeV2() {
    ...
    >
      <div className="h-screen flex flex-col">
        ...
        <header className="border-b px-4 py-3 flex items-center justify-between shrink-0 bg-black/50 backdrop-blur-sm">
          ...
          <div className="text-sm text-muted-foreground">Demo Mode V2</div>
        </header>
              ...
              <AnimatePresence>
                {currentArtifact && isCanvasOpen && (
                  ...
                  >
                    ...
                    {/* Enhanced V2 game with animations and effects */}

        ...
        <SidebarInset>
          <main className="flex h-screen flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-hidden">
              {!showChat ? <div className="flex h-full flex-col items-center justify-center p-8">
                  ...
                  <PromptInput value={input} onValueChange={handleValueChange} isLoading={isLoading} onSubmit={handleSubmit} className="w-full max-w-3xl">
                ...
                </div> : <ChatInterface sessionId={currentSessionId} initialPrompt={input} />}
            </div>
          </main>
        </SidebarInset>
      </SidebarProvider>

...
export const Icons = {
  brain: (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
      <path d="M12 2C8.5 2 5.5 4.5 5.5 8c0 1.5.5 2.5 1 3.5C5.5 12.5 5 14 5 16c0 3.5 3 6 6.5 6s6.5-2.5 6.5-6c0-2-.5-3.5-1.5-4.5.5-1 1-2 1-3.5 0-3.5-3-6-6.5-6z" />
      <path d="M8 12h8" />
      <path d="M8 16h8" />
    </svg>
  ),
  ...
  canvas: (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>

...
def validate_python_version():
    ...
    version_ok = current_version.major == required_major and current_version.minor >= required_minor
...
def validate_environment():
    ...
    critical_files = ["pyproject.toml", "agents/vana/team.py", "lib/_tools/adk_tools.py", "main.py"]

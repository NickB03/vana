#!/usr/bin/env python3
"""
Generate embeddings for knowledge documents and save them to a JSON file.
"""
...
def main():
    ...
    for i, file_path in enumerate(doc_files):
        ...
        for j, chunk in enumerate(chunks):
            print(f"  Generating embedding for chunk {j+1}/{len(chunks)}")
    ...
    print("You can now upload this file to Vector Search using the Google Cloud Console.")

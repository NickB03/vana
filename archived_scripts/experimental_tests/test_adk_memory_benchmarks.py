...
class TestADKMemoryBenchmarks:
    ...
    @pytest.mark.asyncio
    async def test_latency_comparison_simple_queries(self, mock_adk_memory_service, mock_custom_kg_service, benchmark_config):
        ...
        for query in simple_queries:
            for _ in range(10):  # Reduced iterations
                ...
                await mock_adk_memory_service.search_memory("vana", "test_user", query, "simple")
    ...
    @pytest.mark.asyncio
    async def test_throughput_comparison(self, mock_adk_memory_service, mock_custom_kg_service):
        ...
        async def adk_worker():
            ...
            while time.time() - start_time < test_duration:
                await mock_adk_memory_service.search_memory("vana", "test_user", test_query)
                adk_request_count += 1

...
class VanaAgent:
    ...
    def register_tool(
        self, tool_name: str, tool_function: Callable, description: str = None
    ):
        """
    ...
    def process_message(
        self, message: str, session_id: str = None, user_id: str = None
    ) -> str:
        """
        ...
        if session_id:
            if self.current_session_id and session_id != self.current_session_id:
                ...
                if user_id:
                    ...
                    raise ValueError(
                        "User ID is required when setting a new session ID"
                    )
        elif not self.current_session_id:

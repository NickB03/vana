...
class TestAuditLogMiddleware:
    ...
    def setup_method(self):
        """Set up test fixtures."""
        self.app = FastAPI()
        self.app.add_middleware(AuditLogMiddleware, log_paths=["/auth/", "/admin/"])
...
class TestMiddlewareIntegration:
    ...
    def test_security_bypass_through_middleware_chain(self):
        ...
        bypass_attempts = [
            ...
            {"Authorization": "Bearer fake-token", "X-Rate-Limit-Bypass": "admin"},
            # Try to manipulate middleware order
            {"X-Middleware-Order": "skip-auth", "X-Security-Override": "true"},
        ]

...
class ValidationRule(ABC):
    ...
    @abstractmethod
    def validate(self, field_name: str, value: Any, context: Dict[str, Any]) -> Optional[ValidationResult]:
...
class TypeCheckRule(ValidationRule):
    ...
    def __init__(self, expected_type: Union[type, List[type]], name: str = "type_check", **kwargs):
        super().__init__(name, **kwargs)
...
class CustomRule(ValidationRule):
    ...
    def __init__(self, validator: Callable[[str, Any, Dict[str, Any]], Optional[ValidationResult]],
...
class SecurityRule(ValidationRule):
    ...
    def _check_password_strength(self, field_name: str, value: str) -> Optional[ValidationResult]:
    ...
    def _check_secret_key(self, field_name: str, value: str) -> Optional[ValidationResult]:
    ...
    def _check_url_security(self, field_name: str, value: str) -> Optional[ValidationResult]:
        """Check URL security."""
        if not isinstance(value, str):
            return None
    ...
    def _check_file_path_security(self, field_name: str, value: str) -> Optional[ValidationResult]:

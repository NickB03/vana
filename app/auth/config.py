...
class AuthSettings(BaseSettings):
    ...
    google_application_credentials: Optional[str] = Field(default=None, description="Google Cloud credentials path")
    
    # Database Settings
    auth_database_url: Optional[str] = Field(default=None, description="Authentication database URL")

...
class MetricsCollector:
    ...
    def _export_prometheus(self) -> str:
        ...
        lines = [
            f"# HELP vana_requests_total Total number of requests",
            f"# TYPE vana_requests_total counter",
            f"vana_requests_total {metrics.request_count}",
            f"",
            f"# HELP vana_response_time_seconds Response time in seconds",
            f"# TYPE vana_response_time_seconds histogram",
            ...
            f"",
            f"# HELP vana_cpu_usage_percent CPU usage percentage",
            f"# TYPE vana_cpu_usage_percent gauge",
            f"vana_cpu_usage_percent {metrics.cpu_usage}",
            f"",
            f"# HELP vana_memory_usage_percent Memory usage percentage",
            f"# TYPE vana_memory_usage_percent gauge",
            f"vana_memory_usage_percent {metrics.memory_usage}",
            f"",
            f"# HELP vana_cache_hit_rate Cache hit rate",
            f"# TYPE vana_cache_hit_rate gauge",

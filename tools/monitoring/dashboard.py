...
class Dashboard:
    ...
    def get_historical_data(self, component_name: Optional[str] = None, 
                ...
                if component_name:
                    ...
                    if component_name in data.get("health", {}).get("components", {}):
                        filtered_data["health"] = {
                            ...
                            "components": {
                                component_name: data["health"]["components"][component_name]
                            }
                        }
                        ...
                        if metric_name:
                            if metric_name in data["metrics"][component_name]:
                                filtered_data["metrics"] = {
                                    component_name: {
                                        metric_name: data["metrics"][component_name][metric_name]
                                    }
                                }
                        else:
                            filtered_data["metrics"] = {

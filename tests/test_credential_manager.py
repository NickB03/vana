...
class TestCredentialManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_master_key = (
            "dGVzdF9tYXN0ZXJfa2V5X2Zvcl9jcmVkZW50aWFsX21hbmFnZXJfdGVzdHM="
        )
    ...
    def test_get_credential_with_default(self):
        ...
        value = self.credential_manager.get_credential(
            "TEST_API_KEY", default="default_value"
        )
    ...
    def test_store_and_retrieve_credential(self):
        ...
        # Store a credential
        encrypted = self.credential_manager.store_credential(
            "TEST_CRED", "test_value_456", encrypt=True
        )

...
class TestAgentToolsIntegration(unittest.TestCase):
    ...
    def test_tool_registration_and_execution(self):
        ...
        self.assertEqual(self.agent.conversation_history[0]["content"], "!echo Hello, world!")
        self.assertEqual(self.agent.conversation_history[1]["role"], "assistant")
        self.assertEqual(self.agent.conversation_history[1]["content"], "Echo: Hello, world!")
    ...
    def test_multiple_tools(self):
        ...
        echo_response = self.agent.process_message("!echo Hello, world!", user_id="test_user")
    ...
    def test_session_persistence(self):
        ...
        response2 = self.agent.process_message("!echo Second message", session_id=new_session_id)
        
        # Load the first session
        self.agent.load_session(session_id, user_id)
        
        # Process another message in the first session
        response3 = self.agent.process_message("!echo Third message", session_id=session_id)

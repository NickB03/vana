...
# Import the fixtures
from tests.fixtures.vector_search_fixtures import MockVectorSearchClientFixture
...
def test_mock_vector_search_client_fixture():
    ...
    mock_client = MockVectorSearchClientFixture(
        is_available=False, embedding_success=False, search_success=False
    )
...
def test_vector_search_health_checker_fixture(
    vector_search_health_checker, mock_vector_search_client
):

...
class RobustTestValidator:
    ...
    def __init__(self):
        self.mock_indicators = [
            ...
            "placeholder", "demo", "sample", "mock_vector_result",
            "fallback knowledge source", "score of 0.75"
        ]
    ...
    def validate_test_result(self, test_result: Dict[str, Any]) -> TestResult:
        ...
        mock_detected = any("mock" in r.reason.lower() or "fallback" in r.reason.lower() 
    ...
    def _validate_vector_search_evidence(self, response: str) -> ValidationResult:
        ...
        real_indicators = [
            ...
            "relevance score", "document chunk", "rag", "retrieval"
        ]
        
        fallback_indicators = [
            "fallback knowledge", "no memories found", "mock vector",
        ...
        real_count = sum(1 for indicator in real_indicators 
                        if indicator.lower() in response.lower())
    ...
    def _validate_web_search_evidence(self, response: str) -> ValidationResult:
        ...
        real_indicators = [
            "search results", "found", "website", "url", "source",

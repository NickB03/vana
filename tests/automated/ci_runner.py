...
class CIRunner:
    ...
    def save_report(self, filepath: Union[str, Path]):
        ...
        logger.info(f"Test Summary: {summary['successful_suites']}/{summary['total_test_suites']} suites passed "
...
def main():
    ...
    parser.add_argument("--output", type=Path, default="ci-test-results.json",
                       help="Output file for test results")
    parser.add_argument("--suite", choices=["unit", "performance", "security", "integration", "linting", "typing", "all"],

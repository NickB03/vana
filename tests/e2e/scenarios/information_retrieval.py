...
class InformationRetrievalScenario(unittest.TestCase):
    ...
    def _create_agent(self) -> VanaAgent:
        ...
        mock_vector_search = MagicMock(
            return_value=[
                {
                    "text": "VANA is an AI agent with memory and knowledge graph capabilities.",
                    "score": 0.9,
                },
                {
                    "text": "VANA uses Vector Search for semantic retrieval.",
                    "score": 0.8,
                },
            ]
        )
        ...
        mock_search_knowledge = MagicMock(
            return_value=[
                {
                    "text": "Memory systems in AI agents allow for context preservation.",
                    "score": 0.9,
                },
                {
                    "text": "Knowledge graphs store structured information about entities and relationships.",
                    "score": 0.8,
                },
            ]
        )
            ...
            return_value=[
                {
                    "name": "VANA",
                    "type": "project",
                    "observation": "VANA is an AI project with memory capabilities.",
                },
                {
                    "name": "Vector Search",
                    "type": "technology",
                    "observation": "Vector Search is used for semantic retrieval.",
                },
            ]
        )
        ...
        mock_kg_extract_entities = MagicMock(
            return_value=[
                ...
                },
                {
                    "name": "Vector Search",
                    "type": "technology",
                    "observation": "Vector Search is a technology.",
                },
            ]
        )
    ...
    def test_information_retrieval_scenario(self):
        ...
        self.agent.process_message(
            "Please remember that VANA is an AI project with memory and knowledge graph capabilities.",
            session_id=self.session_id,
        )
        ...
        self.agent.process_message(
            "Also remember that VANA uses Vector Search for semantic retrieval.",
            session_id=self.session_id,
        )
        ...
        self.agent.process_message(
            "Can you search for information about memory systems in AI agents?",
            session_id=self.session_id,
        )
        ...
        self.agent.process_message(
            "What are the latest developments in AI agent technology? Please search the web.",
            session_id=self.session_id,
        )
        ...
        self.agent.process_message(
            "What's my name and what am I interested in?", session_id=self.session_id
        )
        ...
        self.agent.process_message(
            "Can you extract entities from this text: 'VANA is an AI project that uses Vector Search and Knowledge Graph technologies.'",
            session_id=self.session_id,
        )

...
class BasicConversationTest(TestCase):
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            description="Comprehensive test for basic conversation with the VANA agent"
        )
    ...
    def _run(self):
        ...
        share_response = self._send_message_and_verify(
            f"I want to tell you something about myself: {random_fact}.",
            "share_info",
            ["thank", "remember", "noted"]
        )
        ...
        follow_up_response = self._send_message_and_verify(
            "Can you remember what I just told you about myself?",
            "follow_up",
            random_fact
        )
        ...
        memory_response = self._send_message_and_verify(
            "What was the first thing I asked you in our conversation?",
            "memory",
            ["hello", "how are you"]
        )
        ...
        self.assert_true("book" in response_text or "ai" in response_text or "artificial intelligence" in response_text,

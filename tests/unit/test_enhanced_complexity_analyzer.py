...
class TestEnhancedComplexityAnalyzer:
    ...
    def test_enterprise_task_detection(self, analyzer):
        ...
        result = analyzer.analyze_task("Design and implement an enterprise-wide microservices migration strategy")
    ...
    def test_multiple_domain_detection(self, analyzer):
        ...
        result = analyzer.analyze_task("Build a secure ML-powered web application with real-time monitoring")
    ...
    def test_specialist_assignment(self, analyzer):
        ...
        result = analyzer.analyze_task("Build a secure, scalable ML platform with monitoring")
    ...
    def test_effort_estimation(self, analyzer):
        ...
        for task, expected_efforts in test_cases:
            result = analyzer.analyze_task(task)
            assert (
                result.estimated_effort in expected_efforts
            ), f"Failed for: {task}. Got {result.estimated_effort}, expected one of {expected_efforts}"

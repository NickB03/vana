...
class TestValidateSecurityCompliance:
    ...
    def test_multiple_compliance_standards(self):
        ...
        result = validate_security_compliance(
            "payment_system",
            requirements=["OWASP", "PCI-DSS"]
        )
...
class TestAssessInputValidation:
    ...
    def test_email_validation(self):
        ...
        assert result["input_safe"] or not any(
            issue["severity"] == "HIGH" for issue in result["validation_issues"]
        )

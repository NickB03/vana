...
class TestWebSearchTool:
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_web_search_basic_functionality(self, mock_brave_response):
        ...
        with patch("httpx.AsyncClient.get") as mock_get:
            ...
            result = await web_search("What time is it in London?")
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_web_search_data_extraction(self, mock_brave_response):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_web_search_special_characters(self, mock_brave_response):
        ...
        with patch("httpx.AsyncClient.get") as mock_get:
            ...
            result = await web_search(special_query)
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_web_search_long_query(self, mock_brave_response):
        ...
        with patch("httpx.AsyncClient.get") as mock_get:
            ...
            result = await web_search(long_query)
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_web_search_api_timeout(self):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_web_search_http_error_codes(self):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_web_search_concurrent_requests(self, mock_brave_response):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_web_search_data_processing(self, test_data_manager):
        ...
        for scenario in scenarios[:3]:  # Test first 3 scenarios
            with patch("httpx.AsyncClient.get") as mock_get:
                ...
                result = await web_search(scenario.query)
...
class TestWebSearchToolIntegration:
    ...
    @pytest.mark.network
    @pytest.mark.asyncio
    async def test_web_search_real_api_call(self):
    ...
    async def test_web_search_performance(self):
        ...
        result = await web_search("Current time")
        end_time = time.time()

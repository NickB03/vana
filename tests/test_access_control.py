...
class TestAccessControl(unittest.TestCase):
    ...
    def test_operation_permissions(self):
        ...
        self.assertEqual(self.acm.operation_permissions[Operation.RETRIEVE_ENTITY], PermissionLevel.READ)
        self.assertEqual(self.acm.operation_permissions[Operation.SEARCH], PermissionLevel.READ)
        
        # Test write operations
        self.assertEqual(self.acm.operation_permissions[Operation.STORE_ENTITY], PermissionLevel.WRITE)
        self.assertEqual(self.acm.operation_permissions[Operation.CREATE_RELATIONSHIP], PermissionLevel.WRITE)
        
        # Test admin operations
        self.assertEqual(self.acm.operation_permissions[Operation.PURGE_ENTITIES], PermissionLevel.ADMIN)
        self.assertEqual(self.acm.operation_permissions[Operation.RESET_KNOWLEDGE_GRAPH], PermissionLevel.ADMIN)
    ...
    def test_authorize(self):
        ...
        self.assertTrue(self.acm.authorize(Role.GUEST, Operation.RETRIEVE_ENTITY, "public"))
        self.assertFalse(self.acm.authorize(Role.GUEST, Operation.RETRIEVE_ENTITY, "user"))
        self.assertFalse(self.acm.authorize(Role.GUEST, Operation.STORE_ENTITY, "public"))
        
        # Test user authorization
        self.assertTrue(self.acm.authorize(Role.USER, Operation.RETRIEVE_ENTITY, "public"))
        ...
        self.assertTrue(self.acm.authorize(Role.ADMIN, Operation.RETRIEVE_ENTITY, "public"))

...
"""
    ...
    async def _allocate_resources(self, env_id: str, resources: dict[str, Any]):
        ...
        for resource_type, _config in resources.items():
...
class TestOrchestrator:
    ...
    async def discover_tests(
        self, test_directory: Path, test_types: list[TestType] | None = None
    ...
    async def execute_test_suite(
        self, suite_id: str, environment_config: dict[str, Any] | None = None
    ) -> dict[str, TestResult]:

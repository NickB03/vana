...
class RegressionDetector:
    ...
    def detect_regression(self, 
                         ...
                         baseline_std_dev: Optional[float] = None) -> Optional[PerformanceRegression]:
        """
        ...
        logger.warning(f"Performance regression detected: {benchmark_name}.{metric_name} "
    ...
    def detect_trend_regression(self,
                               benchmark_name: str,
                               metric_name: str,
                               historical_values: List[Tuple[float, float]],  # (timestamp, value)
                               trend_window: int = 5) -> Optional[PerformanceRegression]:
        """
    ...
    def get_critical_regressions(self) -> List[PerformanceRegression]:
        ...
        return [r for r in self.detected_regressions 
    ...
    def configure_thresholds(self,
        ...
        logger.info(f"Updated regression thresholds: minor={self.minor_threshold}%, "

...
class BaselineManager:
    ...
    def establish_baseline(
        self, benchmark_name: str, metric_name: str, values: List[float], unit: str, confidence_level: float = 0.95
    ) -> PerformanceBaseline:
    ...
    def compare_to_baseline(self, benchmark_name: str, metric_name: str, current_value: float) -> Dict[str, Any]:
        ...
        if not baseline:
            return {"has_baseline": False, "message": f"No baseline found for {benchmark_name}.{metric_name}"}
    ...
    def get_baseline_summary(self) -> Dict[str, Any]:
        ...
        summary = {"total_baselines": len(baselines_list), "total_benchmarks": len(by_benchmark), "benchmarks": {}}

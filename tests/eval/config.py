...
class ConfigManager:
    ...
    def get_browser_config(self) -> Dict[str, Any]:
        ...
        return {"headless": self.config.browser_headless, "timeout": self.config.browser_timeout}
    ...
    def get_paths(self) -> Dict[str, str]:
        ...
        return {"results_dir": self.config.results_dir, "evalsets_dir": self.config.evalsets_dir}
...
TOOL_PATTERNS = {
    ...
    "get_health_status": [
        ...
        "operational",
        "monitoring",
        "*using get_health_status*",
        "health check",
        "system status",
    ],
    "echo": ["echo", "repeat", "message back", "echoing", "*using echo*", "echo back", "repeating"],
    "coordinate_task": [
        "coordinate",
        "workflow",
        "specialists",

...
class TestVanaMemoryService:
    ...
    def test_initialization_with_valid_config(self, memory_service_config):
        ...
        with patch('vana_multi_agent.memory.vana_memory_service.VertexAiRagMemoryService') as mock_vertex:
            mock_vertex.return_value = MagicMock()
            
            with patch('vana_multi_agent.memory.vana_memory_service.VanaMemoryService') as MockService:

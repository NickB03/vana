...
from vana.adk_integration import ADKSessionAdapter, ADKStateManager, ADKEventHandler
...
class TestADKEventHandler(unittest.TestCase):
    ...
    def test_register_event_handler(self):
        ...
        self.assertIn(handler, self.event_handler.event_handlers[ADKEventHandler.EVENT_MESSAGE_RECEIVED])
    ...
    def test_unregister_event_handler(self):
        ...
        self.assertNotIn(handler, self.event_handler.event_handlers[ADKEventHandler.EVENT_MESSAGE_RECEIVED])
    ...
    def test_handle_message_sent(self):
        ...
        # Register handler
        self.event_handler.register_event_handler(
            event_type=ADKEventHandler.EVENT_MESSAGE_SENT,
            handler=handler
        )
    ...
    def test_handle_tool_called(self):
        ...
        # Register handler
        self.event_handler.register_event_handler(
            event_type=ADKEventHandler.EVENT_TOOL_CALLED,
            handler=handler
        )
    ...
    def test_handle_tool_response(self):
        ...
        # Register handler
        self.event_handler.register_event_handler(
            event_type=ADKEventHandler.EVENT_TOOL_RESPONSE,
            handler=handler
        )
        ...
        self.assertEqual(context.data["tool_responses"][0]["tool_args"]["arg1"], "value1")
        self.assertEqual(context.data["tool_responses"][0]["tool_args"]["arg2"], "value2")
    ...
    def test_handle_error(self):
        ...
        # Register handler
        self.event_handler.register_event_handler(
            event_type=ADKEventHandler.EVENT_ERROR,
            handler=handler
        )
    ...
    def test_handle_session_created(self):
        ...
        # Register handler
        self.event_handler.register_event_handler(
            event_type=ADKEventHandler.EVENT_SESSION_CREATED,
            handler=handler
        )
    ...
    def test_handle_session_updated(self):
        ...
        # Register handler
        self.event_handler.register_event_handler(
            event_type=ADKEventHandler.EVENT_SESSION_UPDATED,
            handler=handler
        )

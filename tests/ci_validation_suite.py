...
class CIValidator:
        ...
        if success:
            ...
            results.append(
                ValidationResult(
                    ...
                    "python_detection",
                    TestResult.PASS,
                    f"Found {len(python_versions)} Python versions",
                    duration,
            ...
            results.append(
                ValidationResult(
                    ...
                    "python_detection",
                    TestResult.WARN,
                    f"Python detection issue: {stderr}",
                    duration,
                )
            )
        ...
        if success:
            results.append(
                ValidationResult(
                    ...
                    "project_sync",
                    TestResult.PASS,
                    "Project sync validation passed",
                    duration,
                )
            )
        else:
        ...
        if success and test_venv.exists():
            ...
            results.append(
                ValidationResult(
                    ...
                    "venv_creation",
                    TestResult.FAIL,
                    f"Virtual environment creation failed: {stderr}",
                    duration,
                )
            )
        ...
        if success:
            ...
            results.append(
                ValidationResult(
                    ...
                    "deps_install",
                    TestResult.FAIL,
                    f"Dependencies installation failed: {stderr}",
                    duration,
                    details=stdout if self.verbose else None,
                )
            )
        ...
        if success:
            results.append(
                ValidationResult(
                    ...
                    "pytest_available",
                    TestResult.PASS,
                    f"Pytest available: {stdout.strip()}",
                    duration,
                )
            )
        else:
        ...
        if success:
            ...
            results.append(
                ValidationResult(
                    ...
                    "test_discovery",
                    TestResult.PASS,
                    f"Discovered {test_count} backend tests",
                    duration,
                )
            )
        else:
            results.append(
                ValidationResult(
                    ...
                    "test_discovery",
                    TestResult.FAIL,
                    f"Test discovery failed: {stderr}",
                    duration,
                    details=stdout if self.verbose else None,
                )
            )
        ...
        if not syntax_errors:
            results.append(
                ValidationResult(
                    ...
                    sum(
                        [r.duration for r in results[-len(test_files) :]]
                        if results
                        else [0]
                    ),
                )
    ...
    def validate_frontend_tests(self) -> list[ValidationResult]:
        ...
        if success:
            results.append(
                ValidationResult(
                    "frontend", "linting", TestResult.PASS, "Linting passed", duration
                )
            )
        else:
        ...
        if success:
            results.append(
                ValidationResult(
                    "frontend", "build", TestResult.PASS, "Build successful", duration
                )
            )
        else:
            results.append(
    ...
    def validate_type_checking(self) -> list[ValidationResult]:
        ...
        start_time = time.time()
        success, stdout, stderr = self.run_command(
            ["npx", "tsc", "--version"], cwd=frontend_dir
        )
        duration = time.time() - start_time
        ...
        if success:
            results.append(
                ValidationResult(
                    ...
                    "tsc_available",
                    TestResult.PASS,
                    f"TypeScript compiler: {stdout.strip()}",
                    duration,
                )
            )
        else:
            results.append(
                ValidationResult(
                    ...
                    "tsc_available",
                    TestResult.FAIL,
                    f"TypeScript compiler not available: {stderr}",
                    duration,
                )
            )
            return results
        ...
        if success:
            ...
            if success:
                ...
                results.append(
                    ValidationResult(
                        ...
                        "backend_type_check",
                        TestResult.WARN,
                        "Backend type checking has issues",
                        duration,
                        details=stderr[:500] if self.verbose else None,
                    )
                )
            ...
            results.append(
                ValidationResult(
                    ...
                    "mypy_available",
                    TestResult.SKIP,
                    "MyPy not available for backend type checking",
                    duration,
                )
            )
    ...
    def validate_dependencies(self) -> list[ValidationResult]:
        ...
        if success:
            results.append(
                ValidationResult(
                    ...
                    "backend_resolution",
                    TestResult.PASS,
                    "Backend dependencies resolved correctly",
                    duration,
                )
            )
        else:
            results.append(
                ValidationResult(
                    ...
                    "backend_resolution",
                    TestResult.FAIL,
                    f"Backend dependency conflicts: {stderr}",
                    duration,
                )
            )
        ...
        start_time = time.time()
        success, stdout, stderr = self.run_command(
            ["pnpm", "audit", "--audit-level=high"], cwd=frontend_dir
        )
        duration = time.time() - start_time
        ...
        if success:
            results.append(
                ValidationResult(
                    ...
                    "frontend_security",
                    TestResult.PASS,
                    "Frontend dependencies security check passed",
                    duration,
                )
            )
        else:
            ...
            if "high" in stderr.lower() or "critical" in stderr.lower():
                ...
                results.append(
                    ValidationResult(
                        ...
                        "frontend_security",
                        TestResult.WARN,
                        "Some security advisories found (low severity)",
                        duration,
                    )
                )
            ...
            if match:
                ...
                if 3.10 <= py_version < 3.14:
                    results.append(
                        ValidationResult(
                            ...
                            "python_version",
                            TestResult.PASS,
                            f"Compatible Python version: {version}",
                            duration,
                        )
                    )
                else:
                    results.append(
                        ValidationResult(
                            ...
                            "python_version",
                            TestResult.WARN,
                            f"Python version may not be supported: {version}",
                            duration,
                        )
                    )
            else:
                results.append(
                    ValidationResult(
                        ...
                        "python_version",
                        TestResult.WARN,
                        f"Could not parse Python version: {version}",
                        duration,
                    )
                )
        else:
        ...
        if success:
            ...
            if match and int(match.group(1)) >= 20:
                results.append(
                    ValidationResult(
                        ...
                        "node_version",
                        TestResult.PASS,
                        f"Compatible Node.js version: {version}",
                        duration,
                    )
                )
            else:
                results.append(
                    ValidationResult(
                        ...
                        "node_version",
                        TestResult.WARN,
                        f"Node.js version may be outdated: {version}",
                        duration,
                    )
                )
        else:
            results.append(
                ValidationResult(
                    ...
                    "node_version",
                    TestResult.FAIL,
                    f"Node.js not available: {stderr}",
                    duration,
                )
            )
            ...
            if component in component_validators:
                ...
                try:
                    ...
                    for result in results:
                        logger.info(
                            f"{result.result.value} {result.test_name}: {result.message}"
                        )
                        if result.details and self.verbose:
                            logger.debug(f"Details: {result.details}")

                except Exception as e:
                    logger.error(f"Error validating {component}: {e!s}")
    ...
    def generate_report(self, results: dict[str, list[ValidationResult]]) -> str:
        ...
        for component, component_results in results.items():
            ...
            for result in component_results:
                ...
                report_lines.append(
                    f"  {result.result.value} {result.test_name}: {result.message}{duration_str}"
                )

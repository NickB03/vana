...
class MockVectorSearchClientFixture:
    ...
    def get_health_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "message": "Mock Vector Search client is healthy" if self.is_available_flag else "Mock Vector Search client is unhealthy",
            "details": {
                "initialized": True,
                "using_mock": True,
...
def vector_search_health_checker(request, mock_vector_search_client):
    ...
    if use_real_client:
        ...
        client = VectorSearchClient(
            ...
            credentials_path=client_params.get('credentials_path', os.environ.get('TEST_GOOGLE_APPLICATION_CREDENTIALS'))
        )
    else:

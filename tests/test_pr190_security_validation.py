...
class TestPR190SecurityValidation:
    ...
    def test_phoenix_debug_endpoint_requires_x_phoenix_code_header(
        ...
        response = client.get(
            "/api/debug/phoenix", headers={"Authorization": f"Bearer {superuser_token}"}
        )
    ...
    def test_phoenix_debug_endpoint_disabled_in_production(
        self, client, superuser_token
    ):
    ...
    def test_phoenix_debug_endpoint_redacts_sensitive_data(
        self, client, superuser_token
    ):
    ...
    def test_jwt_token_type_validation(self, client):
        ...
        wrong_type_token = jwt.encode(
            wrong_type_payload, JWT_SECRET_KEY, algorithm=JWT_ALGORITHM
        )
    ...
    def test_rate_limiting_on_auth_endpoints(self, client):
        ...
        assert response.status_code in [
            ...
            401,
            422,
        ]  # Validation or auth error, not rate limit

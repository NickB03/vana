    ...
    def test_document_processor(self):
        ...
        try:
            ...
            document = processor.process_document(
                ...
                metadata={"source": "test", "doc_id": "test-doc-001"},
            )
    ...
    def test_web_search(self):
        ...
        try:
            ...
            if not web_search.is_available():
                logger.warning(
                    "Web Search is not available. Testing mock web search instead."
                )
                from tools.web_search_mock import MockWebSearchClient
    ...
    def test_feedback_manager(self):
        ...
        try:
            ...
            entity_result = feedback_manager.store_entity_feedback(
                ...
                entity_type="test",
                extracted_data={"name": "Test entity", "type": "test"},
                is_correct=True,
                comment="Test comment",
                user_id="test_user",
            )
    ...
    def test_knowledge_base_expansion(self):
        ...
        try:
            ...
            result = process_directory(
                directory=test_dir, file_types=["md"], recursive=False
            )
